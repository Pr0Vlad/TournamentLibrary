...
namespace TournamentLibrary.DataAccess.TextHelper
{
    public static class TextProccessor
    {
        ...
        private static MatchupModel LookupMatchupById(int id)
        {
            ...
            foreach(string matchup in matchups)
            {
                ...
                if(cols[0] == id.ToString())
                {
                    ...
                    matching.Add(matchup);
                    return matching.ConvertToMatchupModels().First();
                }
            }
            return null;
        }
        private static List<MatchupEntryModel> ConvertStringToMatchupEntryModels(string input)
        {
            ...
            output = matching.ConvertToMatchupEntryModels();
            return output;
        ...
        private static TeamModel LookupTeamById(int id)
        {
            ...
            foreach(string team in teams)
            {
                ...
                if (cols[0] == id.ToString())
                {
                    List<string> matching = new List<string>();
                    matching.Add(team);
                    return matching.ConvertToTeamModels(GlobalConfig.PeopleFile).First();
                }
            }
            return null;
        }
        ...
        {
           List<MatchupModel> matchups = GlobalConfig.MatchupFile.fullFilePath().LoadFile().ConvertToMatchupModels();
           MatchupModel older = new MatchupModel();
        ...
        {
            List<MatchupEntryModel> entries = GlobalConfig.MatchupEntryFile.fullFilePath().LoadFile().ConvertToMatchupEntryModels();
            MatchupEntryModel older = new MatchupEntryModel();
